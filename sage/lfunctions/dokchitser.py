...
class Dokchitser(SageObject):
    ...
    of a rank $2$ curve.
        ...
        1.51863300057685
        sage: L.taylor_series(1,4)
        -0.0000000000000000000000128158145691931 + 0.00000000000000000000000726268290635586*z + 0.759316500288426*z^2 + -0.430302337583361*z^3 + O(z^4)     # 32-bit
        -0.0000000000000000000000269129566562796 + 0.00000000000000000000001525149019687825*z + 0.759316500288426*z^2 + -0.43030233758336200*z^3 + O(z^4)   # 64-bit
