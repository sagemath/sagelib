...
class Dokchitser(SageObject):
    ...
    We compute with the $L$-series of a rank $1$ curve.
        ...
        0.0000000000000000061121897480000001
    ...
    of a rank $2$ curve.
        ...
        1.5186330005768536
        sage: L.taylor_series(1,4)
        -0.000000000000000000000012815814569200001 + 0.0000000000000000000000072626829063600006*z + 0.75931650028842679*z^2 + -0.43030233758336200*z^3 + O(z^4)
