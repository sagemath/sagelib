...
notebook_help = [
            ...
            ('Splitting and Joining cells', 'With your cursor in an input cell, press ctrl-enter to split the cell -- the text before your cursor will remain in that cell, and the text after the cursor will be inserted into a new cell.  Similarly, press ctrl-backspace to join the current cell to the one immediately above it.'),
