...
class GroebnerFan(SageObject):
    ...
    def __init__(self, I, is_groebner_basis=False, symmetry=None, verbose=False):
        ...
        EXAMPLES:
            sage: R = PolynomialRing(QQ, 3, 'x,y,z', order='lex')
    ...
    def _gfan_maps(self):
        ...
        EXAMPLES:
            sage: R = PolynomialRing(QQ,3,'x,y,z')
    ...
    def _gfan_ideal(self):
        ...
        EXAMPLES:
            sage: PolynomialRing(QQ,3,'x,y,z')
            sage: G = R.ideal([x^2*y - z, y^2*z - x, z^2*x - y]).groebner_fan()
            sage: G._gfan_ideal()
    ...
    def fvector(self):
        ...
        EXAMPLES:
            sage: R = PolynomialRing(QQ,'x,y', 2)
    ...
    def tropical_basis(self, check=True):
        ...
        INPUT:
            check -- bool (default: True); if True raises a ValueError
                     ...
                     not satisfied).
        EXAMPLES:
            sage: R = PolynomialRing(QQ,'x,y,z',order='lex')
