...
def complex_roots(p, skip_squarefree=False, retval='interval', min_prec=0):
    ...
    for printing, to get predictable doctest results.
        ...
        (<type 'sage.rings.complex_interval.ComplexIntervalFieldElement'>, [[1.618033988749894... .. 1.6180339887498952]*I, [-1.6180339887498952 .. -1.6180339887498944], [0.61803398874989468 .. 0.61803398874989502], [-0.61803398874989502 .. -0.61803398874989468]*I])
